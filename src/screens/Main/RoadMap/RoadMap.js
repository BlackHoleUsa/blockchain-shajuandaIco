...
const RoadMapSection = (props) => {
    ...
    return(
        ...
        <div className="app-flex-column w-100 py-5 text-white justify-content-center align-items-center">
            ...
            <h6 className="font-36px mb-2 heading-font">Roadmap To Success</h6>
            <p className="font-16px d-block text-center paragraph-font">
            ICO seemed to float in the middle of an immense dark sphere, whose upper half was strewn with silver.
            </p>

            <RoadMapContain />

            <h6 className="font-36px mb-2 mt-5 pt-3 heading-font" id="team-section">Our Awesome Team</h6>
            <p className="font-16px d-block text-center paragraph-font">
                ICO seemed to float in the middle of an immense dark sphere, whose upper half was strewn with silver.
            </p>

            <img alt="" width="244px" height="244px" src={Images.shajuanda} className="mt-5 mb-3" />
            <h6 className="font-20px mb-2 heading-font">Shajuanda</h6>
            <span className="font-16px mb-2 heading-font">
                Business owner
            </span>
            <span className="font-16px mb-3 d-block text-center heading-font">
                White-Founder-IT Consulting Expert-Entrepreneur Grambling State University
            </span>
            <span className="font-16px text-center d-block paragraph-font">
            ...
            <h6 className="font-36px mb-2 my-5 pt-5 heading-font">Team Members</h6>
            ...
            <button className="gradient-apply connect-wallet border-0 my-5 paragraph-font">
                See All
            </button>
