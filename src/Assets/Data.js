...
export const featureData = [
    ...
    { id: 2, heading: 'ERC20 compatibility', text: "The ERC-20 token are among the greatest important Ether tokens. ERC-20 has surfaced as the formal definition; it will be used for all digital signatures on the Ethereum blockchain for asset development and establishes a set of rules that must be followed by all Ethereum-based tokens. SA RA Token therefore, will be allowing participants to take part in any transfer within the Ethereum blockchain.", image: Images.jig },
