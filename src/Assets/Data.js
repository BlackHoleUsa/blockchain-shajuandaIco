...
export const featureData = [
    { id: 1, heading: 'Market efficiency ', text: "SA RA Token will ensure that the market is running smoothly by improving on the trading conditions via giving rewards to the market makers. With time, our platform will have better market conditions which will allow us to expand our market cap to accommodate more participant. Besides, SA RA Token awarding culture will make our token competitive in token listing. ", image: Images.bulb },
    { id: 2, heading: 'ERC20 compatibility', text: "The ERC-20 token are among the greatest important Ether tokens. ERC-20 has surfaced as the formal definition; it will be used for all digital signatures on the Ethereum blockchain for asset development and establishes a set of rules that must be followed by all Ethereum-based tokens. ERC-20 tokens are digital assets that can be sent and received on the Ethereum blockchain. SA RA Token therefore, will be allowing participants to take part in any transfer within the Ethereum blockchain.", image: Images.jig },
    { id: 3, heading: 'Continuous distribution', text: "Since our Token is meant to serve as utility token, there it will be distributed across various Ethereum blockchain, it will have a continuous distribution of user in the liquidity as they will contribute in the reward.", image: Images.profit },
    { id: 4, heading: 'Decentralized ownership', text: "SA RA Token will facilitate in distribution of decentralized ownership of ERC-20 token across the Ethereum Blockchain networks. Our participants will have a chance to distribute their digital wealth across one of the most popular and fastest growing blockchain network in the industry of cryptocurrency.", image: Images.line },
